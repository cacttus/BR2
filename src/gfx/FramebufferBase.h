...
public:
    ...
    static std::shared_ptr<BufferRenderTarget> createTarget(string_t strName, GLenum texFormat, GLenum internalFormat,
    ...
    static std::shared_ptr<BufferRenderTarget> createDepthTarget(string_t strName, int32_t w, int32_t h, int iIndex, bool bMsaaEnabled, int32_t nMsaaSamples);
