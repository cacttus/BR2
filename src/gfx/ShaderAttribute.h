...
*  @brief An OpenGL GLSL shader attribute.
*/
...
private:
  ...
  int32_t _iGLLocation = NoAttribLocationFound;    //shader location
  GLenum _eGLAttribType = 0;
  GLsizei _iGLAttribSize = 0;//*Note this isn't the "components" But would return "1" for FLOAT_VEC3 etc.
  string_t _strError;
