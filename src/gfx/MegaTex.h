...
public:
  MtTexPatch(std::shared_ptr<MegaTex> pTex, std::string imgName, Hash32 nameHash);
...
public:
  MtFont(std::shared_ptr<MegaTex> pTex, std::string name, Hash32 nameHash);
...
public:
  MegaTex(std::shared_ptr<GLContext> ct);
