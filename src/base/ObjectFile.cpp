...
void ObjectFile::addFaceVertex(int32_t iVertex, int32_t iTCoord, int32_t iNormal) {
...
int32_t ObjectFile::addNewMeshVertex(int32_t vi, int32_t xi, int32_t ni) {
  int32_t newIndex;
  ModelVertexType vx;
...
void ObjectFile::addCurrentSpec() {
...
int32_t ObjectFile::findCachedVertex(int32_t vi, int32_t xi, int32_t ni) {
  ivec3 v;
  v.x = vi;
  v.y = xi;
  v.z = ni;
...
void ObjectFile::addCachedVertex(int32_t newIndex, int32_t vi, int32_t xi, int32_t ni) {
  ivec3* v = new ivec3();
  v->x = vi;
  v->y = xi;
  v->z = ni;
...
void ObjectFile::clearVertexCache() {
