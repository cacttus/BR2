...
/**
*    @class BufferedFile
*    @brief File which is loaded into a static buffer in memory via the memory manager.
*/
class BufferedFile : public VirtualMemory { 
public:
    enum { file_eof = -1 };
...
public:
    ...
    BufferedFile();
    BufferedFile(size_t buffer_size);
