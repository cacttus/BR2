...
namespace Game {
///////////////////////////////////////////////////////////////////
//Package::FileBuffer::FileBuffer(){
//}
//Package::FileBuffer::~FileBuffer(){
//    freeData();
//}
//void Package::FileBuffer::alloc(int32_t iLength) {
//    _iLength = iLength;
//    _pBytes = new char[iLength];
//}
//void Package::FileBuffer::freeData(){
//    _iLength = 0;
//    delete [] _pBytes;
//}

//bool Package::FileBuffer::loadFileDisk(std::string loc) {
//    int err = FileSystem::SDLFileRead(loc.c_str(), _pBytes, _iLength);
//    if (err != 0) {
//        //Error
//        BroLogError("File '", loc, "' not found");
//        return false;
//    }
//    return true;
//
...
//    //if (!fs.good()) {
//    //    fs.close();
//    //    BroThrowException("Failed to open file.");
//    //}
