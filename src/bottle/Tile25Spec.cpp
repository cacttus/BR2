...
namespace Game {
///////////////////////////////////////////////////////////////////
Tile25Spec::Tile25Spec(t_string name, uint8_t iIndex, GridMeshLayer::e em, std::shared_ptr<SpriteSpec> top, std::shared_ptr<SpriteSpec> side, 
...
///////////////////////////////////////////////////////////////////
MorphTile::MorphTile(t_string strName) {
    _strName = strName;
