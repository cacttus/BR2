...
//}
//void BottleRoom::setup(std::shared_ptr<RenderViewport> pv, std::shared_ptr<GLContext> ct) {
//  _pContext = ct;
//  t_timeval t0;
//
//  createGameSaveDir();
...
//}
//
//string_t BottleRoom::getGameDirectory(string_t gameName) {
//  return FileSystem::combinePath(_strGameSaveDir, gameName);
//}
//string_t BottleRoom::getWorldDirectory(string_t gameName, string_t worldName) {
//  return FileSystem::combinePath(getGameDirectory(gameName), worldName);
//}
//string_t BottleRoom::getNewWorldName(string_t gameName) {
...
//  return wn;
//}
//bool BottleRoom::loadOrCreateGame(string_t gameName) {
//  unloadGame();
//
...
//  partyAtlas->addImage(0, Gu::getPackage()->makeAssetPath("spr", "sp-particle.png"));
//  partyAtlas->addImage(1, Gu::getPackage()->makeAssetPath("spr", "sp-particle.png"));
//  partyAtlas->addImage(2, Gu::getPackage()->makeAssetPath("spr", "sp-particle.png"));
//  partyAtlas->addImage(3, Gu::getPackage()->makeAssetPath("spr", "sp-particle.png"));
...
//  }
//}
//void BottleRoom::toggleDebug(std::shared_ptr<InputManager> pFingers) {
...
//  }
//}
//void BottleRoom::updateTouch(std::shared_ptr<InputManager> pFingers, float delta) {
//  Gu::pushPerf();
...
//}
//void BottleRoom::handleGameModeControls(std::shared_ptr<InputManager> pFingers) {
//  if (_eGameMode != GameMode::WorldSelect) {
...
//    _pTex = Gu::getTexCache()->getOrLoad(_pCongaRoom->Gu::getPackage()->makeAssetPath("tex", "test_tex3.png"));
//  }
//
