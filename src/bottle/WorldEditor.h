...
class WorldEditor : public VirtualMemoryShared<WorldEditor> {
    ...
    bool updateShiftEdit(std::shared_ptr<Fingers> pFingers, WorldCell* pc, vec3& n_out);
    void editWorldMouseRelease(std::shared_ptr<Fingers> pFingers);
    ...
    void editWorldMouseDown(std::shared_ptr<Fingers> pFingers);
    void editWorldUpdateHover(std::shared_ptr<Fingers> pFingers);
...
public:
    ...
    void init();
    void editWorld(std::shared_ptr<Fingers> pFingers);
    void drawForward();
