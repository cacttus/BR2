...
//  void addSpec(std::shared_ptr<ModelNode> ms);
//  std::shared_ptr<ModelNode> getModelByName(string_t name);
//  std::shared_ptr<ModelNode> getModelByName(Hash32 hashed);
//  std::shared_ptr<ModelNode> getOrLoadModel(string_t mobFolderAndMobName, bool bUseBinary = true);
...
//private:
//  std::map<Hash32, std::shared_ptr<ModelNode>> _mapModels;
