...
public:
  MeshNode(std::shared_ptr<MeshData> ps, std::shared_ptr<ModelNode> mn);
  MeshNode(std::shared_ptr<MeshData> pd);
  ...
  std::shared_ptr<MeshData> getMeshSpec();
  uint32_t getPickId() { return _iPickId; }

  static std::shared_ptr<MeshNode> create(std::shared_ptr<MeshData> ps, std::shared_ptr<ModelNode> mn);
  static std::shared_ptr<MeshNode> create(std::shared_ptr<MeshData> pd);
