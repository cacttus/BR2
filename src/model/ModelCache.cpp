...
//  std::map<Hash32, std::shared_ptr<ModelNode>>::iterator it = _mapModels.begin();
...
//  //}
//}
//void ModelCache::addSpec(std::shared_ptr<ModelNode> ms) {
...
//  }
//}
//std::shared_ptr<ModelNode> ModelCache::getModelByName(string_t name) {
//  Hash32 h = STRHASH(name);
//  return getModelByName(h);
//}
//std::shared_ptr<ModelNode> ModelCache::getModelByName(Hash32 hash) {
...
//  return filename;
//}
//std::shared_ptr<ModelNode> ModelCache::getOrLoadModel(string_t mobName, bool bUseBinary) {
//
