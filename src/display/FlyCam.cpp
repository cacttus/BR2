...
namespace Game {
///////////////////////////////////////////////////////////////////
FlyCam::FlyCam(std::shared_ptr<GLContext> ct, std::shared_ptr<Viewport> pv) : _pContext(ct), _pViewport(pv)
{
...
void FlyCam::rotateCameraNormal(float rotX, float rotY) {
   // mat4 rot = mat4::getRotationRad(dRot, vec3(0, 1, 0));
    vec3 camPos = _pContext->getCamera()->getPos();
...
#define N_INR(a, b) ((a >= (b-e)) && (a <= (b+e)))
    ...
    //Additional checking to make sure we dont' flip the UI
