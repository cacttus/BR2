...
*/
#pragma once
#ifndef __TRI_PLANE_H__
#define __TRI_PLANE_H__
...
public:
    ...
    FORCE_INLINE TriPlane( vec3&, vec3&, vec3& );
    FORCE_INLINE TriPlane( vec3&, vec3&, vec3&, vec3& n, float d );
    ...
    FORCE_INLINE PlaneHit hitTest(vec3& p1, vec3& p2) const;
    FORCE_INLINE bool hitTest(Ray_t* pr) const;
    FORCE_INLINE void construct( vec3& dp1, vec3& dp2, vec3& dp3 );
...
FORCE_INLINE TriPlane::TriPlane( vec3& dp1, vec3& dp2, vec3& dp3 )
{ 
    construct( dp1, dp2, dp3 );
}
FORCE_INLINE TriPlane::TriPlane( vec3& _dp1,vec3& _dp2,vec3& _dp3,vec3& _n, float _d )
{
    p1 = _dp1;
    p2 = _dp2;
    p3 = _dp3;
...
FORCE_INLINE PlaneHit TriPlane::hitTest( vec3& p1, vec3& p2 ) const
{
    PlaneHit ret;
...
FORCE_INLINE bool TriPlane::hitTest(Ray_t* pr) const {
    PlaneHit ph = hitTest(pr->getBegin(), pr->getEnd());
...
*/
FORCE_INLINE void TriPlane::construct( vec3& dp1, vec3& dp2, vec3& dp3 )
{
    p1=dp1;
    p2=dp2;
    p3=dp3;
