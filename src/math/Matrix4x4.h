...
*    Update: 
*        May 5, 2008
*            Fixed a bug in the code, where a translation atually did a scale.
*            Cleaned up the code and set this class to use the machine types.
*        July 11, 2008: 
*            Critical Update 
*            Fixed the rotation bug.
*        August 3, 2008:
*            Critical Update
*            Fixed Matrix-To-Vector function.
*            Added support for matrix/vector multiplication.
*        *** Changed from a struct to a class *** 
*        September 7, 2009:
*            Added the Determinant function
*            Worked on the Inverse function
*            Worked on the Transpose Function, col, row, minor and cofactor functions
*            9, Added Inverse function, Fixed determinant function
*            Fixed critical Translation bug.
*            Fixed Classical Adjoint bug.
*        20151121 - made inline
*                    moved methods outside the class.
*                    added getOrtho
*                        fixed getVec3 and getVec4 (which were dumb)
*/
/* 
    //helpful diagram
    x   x   x   x
